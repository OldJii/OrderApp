...
import com.oldjii.ordering.adapter.FoodOrderBottomRecycleAdapter;
import com.oldjii.ordering.adapter.LeftListAdapter;
import com.oldjii.ordering.adapter.StickRightListAdapter;
import com.oldjii.ordering.base.BaseActivity;
import com.oldjii.ordering.bean.StickBean;
import com.oldjii.ordering.bmob.AppKeyBean;
import com.oldjii.ordering.bmob.FoodBean;
import com.oldjii.ordering.bmob.FoodCateBean;
...
import com.oldjii.ordering.views.MyTextView;
...
public class ShopFoodActivity extends BaseActivity {
    ...
    private float minPrice = 0.01f;//最低起送价格
    ...
    @OnClick({R.id.id_order_daohan_tv, R.id.id_order_phone_tv, R.id.id_show_food_yddc_tv, R.id.imgCart, R.id.id_order_comment_tv})
                ...
                if (e == null && foods != null && foods.size() > 0) {
                    ...
                    stickyListHeadersListView.setOnStickyHeaderChangedListener(new StickyListHeadersListView.OnStickyHeaderChangedListener() {
                        ...
                        public void onStickyHeaderChanged(StickyListHeadersListView l, View header, int itemPosition, long headerId) {
                            if (leftAdapter != null)
                                leftAdapter.leftItemSelectStateChange((int) headerId);
                        }
                    });
                }
            }
