...
import com.oldjii.ordering.adapter.ImageUpLoadGridAdapter;
...
import com.oldjii.ordering.views.MyGridView;
...
public class PublishFoodActivity extends BaseActivity {
    ...
    @OnClick({R.id.id_food_cate_tv, R.id.add_cate_iv, R.id.id_commit_tv})
